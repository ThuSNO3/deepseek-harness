...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  UiAutomationCallContext: 'ui-automation.md',
  UiAutomationService: 'ui-automation.md',
  UiCursor: 'ui-automation.md',
  UiHostSlotInput: 'ui-automation.md',
  UiHostSlotRef: 'ui-automation.md',
  UiInputValue: 'ui-automation.md',
  UiKey: 'ui-automation.md',
  UiLiteralInput: 'ui-automation.md',
  UiNode: 'ui-automation.md',
  UiRef: 'ui-automation.md',
  UiRequestId: 'ui-automation.md',
  UiSnapshotId: 'ui-automation.md',
  UiSnapshotPage: 'ui-automation.md',
  UiSnapshotRequest: 'ui-automation.md',
  UiValue: 'ui-automation.md',
  UiAction: 'ui-automation.md',
  UiActionReceipt: 'ui-automation.md',
  UiActionRequest: 'ui-automation.md',
  UiWaitRequest: 'ui-automation.md',
  UiWaitResult: 'ui-automation.md',
  UiDescribeRequest: 'ui-automation.md',
  UiRefDescription: 'ui-automation.md',
