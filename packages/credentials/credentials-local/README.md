...
| — | No runtime invariant companion is published; this provider's file/environment layering, teardown, and post-commit notifications are asynchronous I/O pinned by its unit suite, with no independent runtime observation to compare. |
